...
Целью данного исследования является В репозитории представлены инструменты и методы для анализа территорий, включая получение данных, их обработку, анализ пространственных метрик и визуализацию результатов.
